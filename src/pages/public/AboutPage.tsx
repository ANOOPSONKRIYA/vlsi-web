        ...
        <div className="relative">
            ...
            <section className="py-16 px-4">
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div
                            data-aos="fade-left"
                            className="relative aspect-square rounded-3xl overflow-hidden glass-card shadow-2xl"
                        >
                            <img
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {values.map((value, index) => (
                            <div
                                ...
                                className="p-6 rounded-2xl glass-card hover:scale-[1.05] transition-all duration-500 group"
                            >
                                <div className="p-3 rounded-xl bg-white/5 inline-flex mb-4 group-hover:bg-white/10 transition-colors">
                        ...
                        {timeline.map((item, index) => (
                            ...
                            >
                                ...
                                <div className={`flex-1 md:w-1/2 pl-8 md:pl-0 ${index % 2 === 0 ? 'md:pr-8' : 'md:pl-8'}`}>
                                    <div className="p-6 rounded-2xl glass-card hover:scale-[1.02] transition-transform duration-300">
                                        <span className="text-sm font-bold text-zinc-400">{item.year}</span>
            ...
            <section className="py-16 px-4">
                <div className="max-w-4xl mx-auto">
                    <div
                        data-aos="fade-up"
                        className="p-10 rounded-3xl glass-card shadow-2xl"
                    >
