                            ...
                            {filteredProjects.map((project, index) => (
                                ...
                                >
                                    ...
                                    <div className="p-6">
                                        <span
                                            className={cn(
                                                'inline-block px-3 py-1.5 text-xs font-semibold uppercase tracking-wider rounded-full mb-4 backdrop-blur-sm',
                                    ...
                                    {/* Hover overlay */}
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end justify-center pb-8">
                                        <span className="text-white font-bold text-lg tracking-wide">View Project →</span>
                                    </div>
                                </Link>
                            ))}
                        </div>
